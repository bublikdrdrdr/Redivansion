...
public class ByteSettings {
    ...
    private byte[] Collect(LinkedList<DataStruct> inputList) {
        ...
        while (iterator.hasNext()) {
            ...
            switch (type) {
                case 0:
                    ByteConverter.insertArray(TR, ByteConverter.getArray((boolean) dataStruct.object), i);
                    break;
                case 1:
                    ByteConverter.insertArray(TR, ByteConverter.getArray((byte) dataStruct.object), i);
                    break;
                case 2:
                    ByteConverter.insertArray(TR, ByteConverter.getArray((short) dataStruct.object), i);
                    break;
                case 3:
                    ByteConverter.insertArray(TR, ByteConverter.getArray((char) dataStruct.object), i);
                    break;
                case 4:
                    ByteConverter.insertArray(TR, ByteConverter.getArray((int) dataStruct.object), i);
                    break;
                case 5:
                    ByteConverter.insertArray(TR, ByteConverter.getArray((float) dataStruct.object), i);
                    break;
                case 6:
                    ByteConverter.insertArray(TR, ByteConverter.getArray((long) dataStruct.object), i);
                    break;
                case 7:
                    ByteConverter.insertArray(TR, ByteConverter.getArray((double) dataStruct.object), i);
                    break;
                case 8:
                    ByteConverter.insertArray(TR, ByteConverter.getArray((byte[]) dataStruct.object), i);
                    break;
                ...
                case 10:
                    ...
                    break;
                case 11:
                    ByteConverter.insertArray(TR, ByteConverter.getArray((String) dataStruct.object), i);
                    break;
                case 12:
                    ByteConverter.insertArray(TR, ByteConverter.getArray((Bitmap) dataStruct.object), i);
                    break;
            }
            i += dataStruct.size;
        }
