...
public class GameParams {
    ...
    public static final int[] OFFICE_LEVELS_MONTH_COST = new int[]{300, 350, 400, 500}; //1,2,3,4
    public static final int[] OFFICE_LEVELS_POWER = new int[]{-3, -4, -5, -7}; //1,2,3,4
    public static final int[] OFFICE_LEVELS_FIRE = new int[]{-2, -2, -3, -3}; //1,2,3,4
    public static final int[] OFFICE_LEVELS_WATER = new int[]{-3, -3, -3, -3}; //1,2,3,4
    public static final int[] OFFICE_LEVELS_POLLUTION = new int[]{-1, -1, -1, -2}; //1,2,3,4
    public static final int[] OFFICE_LEVELS_CRIMINAL = new int[]{-1, -2, -2, -2}; //1,2,3,4
    public static final int[] OFFICE_LEVELS_HEALTH = new int[]{0, 0, -1, -1}; //1,2,3,4
    public static final int[] OFFICE_LEVELS_MAX_WORK = new int[]{40, 60, 100, 200}; //1,2,3,4
    public static final int[] OFFICE_LEVELS_HAPPINESS = new int[]{1,2,2,3}; //1,2,3,4
    public static final int[] OFFICE_LEVELS_EDUCATION = new int[]{1, 2, 2, 3}; //1,2,3,4
    ...
    public static final int[] THERMAL_POWER_PLANT_LEVELS_HEALTH = new int[]{-2, -3, -4};
    ...
    public static final int[] SHOPPING_MALL_LEVELS_CRIMINAL = new int[]{-5};
    ...
    public static final long[] LEVELS_TIMES = new long[]{5*60*1000, 6*60*1000, 7*60*1000, 10*60*1000, 12*60*1000, 15*60*1000};
