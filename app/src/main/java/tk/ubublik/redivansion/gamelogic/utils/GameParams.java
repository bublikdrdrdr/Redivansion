...
public class GameParams {
    ...
    public static final int[] OFFICE_LEVELS_MONTH_COST = new int[]{400, 500, 600, 700}; //1,2,3,4,5...
    public static final int[] OFFICE_LEVELS_POWER = new int[]{-3, -4, -5, -7}; //1,2,3,4,5...
    public static final int[] OFFICE_LEVELS_FIRE = new int[]{-2, -3, -4, -6}; //1,2,3,4,5...
    public static final int[] OFFICE_LEVELS_WATER = new int[]{-4, -5, -6, -7}; //1,2,3,4,5...
    public static final int[] OFFICE_LEVELS_POLLUTION = new int[]{-1, -2, -3, -4}; //1,2,3,4,5...
    public static final int[] OFFICE_LEVELS_CRIMINAL = new int[]{-1, -2, -3, -4}; //1,2,3,4,5...
    public static final int[] OFFICE_LEVELS_HEALTH = new int[]{-3, -3, -4, -4}; //1,2,3,4,5...
    public static final int[] OFFICE_LEVELS_MAX_WORK = new int[]{40, 60, 100, 200}; //1,2,3,4,5...
    public static final int[] OFFICE_LEVELS_HAPPINESS = new int[]{0,0,0,0}; //1,2,3,4,5...
    public static final int[] OFFICE_LEVELS_EDUCATION = new int[]{1, 2, 4, 5}; //1,2,3,4,5...
    ...
    public static final int[] HOUSE_LEVELS_MONTH_COST = new int[]{100, 200, 300, 400}; // this + per person
    public static final int[] HOUSE_LEVELS_MAX_POPULATION = new int[]{60, 80, 150, 300};
    public static final int[] HOUSE_LEVELS_POWER = new int[]{-4, -5, -6, -8}; // this + per person
    public static final int[] HOUSE_LEVELS_FIRE = new int[]{-3, -4, -5, -7}; // this + per person
    public static final int[] HOUSE_LEVELS_WATER = new int[]{-5, -6, -7, -9}; // this + per person
    public static final int[] HOUSE_LEVELS_POLLUTION = new int[]{-3, -4, -6, -8}; // this + per person
    public static final int[] HOUSE_LEVELS_CRIMINAL = new int[]{-3, -4, -5, -6};
    public static final int[] HOUSE_LEVELS_HEALTH = new int[]{4,4,5,5};
    public static final int[] HOUSE_LEVELS_WORK = new int[]{5, 6, 7, 8};
    public static final int[] HOUSE_LEVELS_HAPPINESS = new int[]{0, -5, -8, -12}; // this + per person
    public static final int[] HOUSE_LEVELS_EDUCATION = new int[]{0, 0, 0, 0}; // this + per person
    ...
    public static final int[] THERMAL_POWER_PLANT_LEVELS_MONTH_COST = new int[]{300, 500, 600};
    public static final int[] THERMAL_POWER_PLANT_LEVELS_POWER = new int[]{50, 60, 75};
    public static final int[] THERMAL_POWER_PLANT_LEVELS_FIRE = new int[]{-8, -10, -12};
    public static final int[] THERMAL_POWER_PLANT_LEVELS_WATER = new int[]{-4, -6, -8};
    public static final int[] THERMAL_POWER_PLANT_LEVELS_POLLUTION = new int[]{-5, -10, -20};
    public static final int[] THERMAL_POWER_PLANT_LEVELS_CRIMINAL = new int[]{0, 0, 0};
    public static final int[] THERMAL_POWER_PLANT_LEVELS_HEALTH = new int[]{-2, -5, -8}; //vot tut hz, daje zabrudnennya, znachyt zabyraje zdorowja
    ...
    public static final float[] THERMAL_POWER_PLANT_LEVELS_RADIUS = new float[]{60, 80, 100};
    ...
    public static final int[] FIRE_STATION_LEVELS_MONTH_COST = new int[]{200};
    public static final int[] FIRE_STATION_LEVELS_POWER = new int[]{-3};
    public static final int[] FIRE_STATION_LEVELS_FIRE = new int[]{30};
    public static final int[] FIRE_STATION_LEVELS_WATER = new int[]{-6};
    ...
    public static final float[] FIRE_STATION_LEVELS_RADIUS = new float[]{49};

    //hospital
    public static final int[] HOSPITAL_LEVELS_BUILD_COST = new int[]{1200};
    public static final int[] HOSPITAL_LEVELS_MONTH_COST = new int[]{400};
    public static final int[] HOSPITAL_LEVELS_POWER = new int[]{-4};
    public static final int[] HOSPITAL_LEVELS_FIRE = new int[]{-2};
    public static final int[] HOSPITAL_LEVELS_WATER = new int[]{-4};
    ...
    public static final float[] HOSPITAL_LEVELS_RADIUS = new float[]{225};
    ...
    public static final int[] POLICE_STATION_LEVELS_MONTH_COST = new int[]{300};
    ...
    public static final float[] POLICE_STATION_LEVELS_RADIUS = new float[]{49};
    ...
    public static final float[] SCHOOL_LEVELS_RADIUS = new float[]{100};

    //shopping mall
    public static final int[] SHOPPING_MALL_LEVELS_BUILD_COST = new int[]{4000};
    public static final int[] SHOPPING_MALL_LEVELS_MONTH_COST = new int[]{0};
    ...
    public static final float[] SHOPPING_MALL_LEVELS_RADIUS = new float[]{75};

    //water plant
    public static final int[] WATER_PLANT_LEVELS_BUILD_COST = new int[]{2500,3000,4000};
    public static final int[] WATER_PLANT_LEVELS_MONTH_COST = new int[]{200, 300, 400};
    public static final int[] WATER_PLANT_LEVELS_POWER = new int[]{10,20,30};
    ...
    public static final int[] LEVELS_MONEY = new int[]{10000, 15000, 20000, 25000, 30000, 40000};
    ...
    public static final int[] LEVELS_POPULATION_GOAL = new int[]{1000, 3000, 5000, 7000, 10000, 12000};
