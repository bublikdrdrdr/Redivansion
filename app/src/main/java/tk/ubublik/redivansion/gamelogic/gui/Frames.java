...
public class Frames {
    ...
    private void initMain(){
        ...
        main.addElement("addSmthing", "+", 0, (80 * dY), (20 * dY), (20 * dY), "pics/test.jpg");
    ...
    private void initSelect(){
        ...
        select.addElement("bg", "", (30 * dX), (10 * dY), (40 * dX), (80 * dY), "pics/test.jpg");
    ...
    private void initAdd(){
        ...
        add.addElement("bg", "", (30 * dX), (5 * dY), (40 * dX), (90 * dY), "pics/test.jpg");
