...
public class TutorialFrames {
    ...
    public static Frame blank() {
        ...
        frame.addElement("bg", "+", false, null, 0, 65, 20, 20, true, "Textures/btn2.png");
    ...
    public static Frame frame(String name) {
        ...
        switch (name) {
            case "about":
                text = "Welcome to Redivansion! In this tutorial you'll learn how to play the game.";
                break;
            case "goals":
                text = "Every level goal is to reach certain population or build something before the time ends.";
                break;
            case "cameraMove":
                text = "To move around, just move your finger. Try now, it's easy!";
                break;
            case "cameraZoom":
                text = "\"Pinch\" gesture allows you to zoom the camera. Try it now!";
                break;
            case "buildAddHouse":
                text = "Now choose position on the map where you want to build it and press \"Add\" button. Look at the colour of square.";
                break;
            case "buildAddRoad1":
                text = "Road building requires two steps. First, choose a start point.";
                break;
            case "buildAddRoad2":
                text = "Next, lead the road to any from four directions you want and build it.";
                break;
            case "objectInfo":
        ...
        frame.addElement("bg", null, false, null, 30, 23, 40, 50, false, "Textures/menubg.png");
    ...
    public static Frame population() {
        ...
        frame.addElement("bg", null, false, null, 30, 23, 40, 50, false, "Textures/menubg.png");
        frame.addElement("bg", "Your current population is shown here.", false, null, 31, 35, 38, 36, false, "Textures/2.png");
        frame.addElement("next", "Next", true, null, 31, 24, 38, 10, false, "Textures/btnLong1.png");
        return frame;
    }
    ...
    public static Frame time() {
        ...
        frame.addElement("bg", null, false, null, 40, 85, 60, 15, false, "Textures/2.png");
        frame.addElement("bg", null, false, null, 30, 23, 40, 50, false, "Textures/menubg.png");
        frame.addElement("bg", "Level end when timer reaches zero. Here you can see how many time you still have.", false, null, 31, 35, 38, 36, false, "Textures/2.png");
        frame.addElement("next", "Next", true, null, 31, 24, 38, 10, false, "Textures/btnLong1.png");
        return frame;
    }
    ...
    public static Frame money() {
        ...
        frame.addElement("bg", null, false, null, 30, 23, 40, 50, false, "Textures/menubg.png");
        frame.addElement("bg", "You build and upgrade everything with money. Here is information about your budget.", false, null, 31, 35, 38, 36, false, "Textures/2.png");
        frame.addElement("next", "Next", true, null, 31, 24, 38, 10, false, "Textures/btnLong1.png");
        return frame;
    }
    ...
    public static Frame buildMenu(boolean road) {
        Element.z = 100;
        String text = road ? "To build the road, open build menu again." : "Now you'll learn how to build something. First, go to the building menu by pressing this button.";
        Frame frame = new Frame("buildMenu" + (road ? "2" : "1"));
        frame.addElement("bg", null, false, null, 0, 0, 100, 100, false, "Textures/2.png");
        frame.addElement("next", "+", true, null, 0, 65, 20, 20, true, "Textures/btn1.png");
    ...
    public static Frame buildChoose(boolean road) {
        ...
        if (road) {
            ...
            frame.addElement("bg", null, false, null, 30, 8, 40, 15, false, "Textures/menubg.png");
            frame.addElement("bg", "Choose road", false, null, 31, 9, 38, 13, false, "Textures/2.png");
        } else {
            ...
            frame.addElement("bg", "Choose object to build. For the first time we will build a house.", false, null, 31, 17, 38, 28, false, "Textures/2.png");
        }
        return frame;
    }
    ...
    public static Frame buildAdd(boolean road) {
        ...
        frame.addElement("next", "+", true, null, 0, 65, 20, 20, true, "Textures/btn1.png");
        frame.addElement("bg", "X", false, null, 0, 45, 20, 20, true, "Textures/btn2.png");
        return frame;
    }
